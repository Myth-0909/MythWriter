...
export function SpreadsheetFormulaBar({ state, onNavigateToCell, onCommitFormulaValue }: SpreadsheetFormulaBarProps) {
  ...
  return (
    <div className="flex min-h-10 shrink-0 items-center gap-2 border-b border-surface-200 bg-white px-3 py-1.5 dark:border-surface-800 dark:bg-surface-950">
      <Input
        value={nameDraft}
        ...
        className="h-8 w-24 shrink-0 text-center text-xs font-semibold uppercase"
      />

...
- **Simple-change discipline**: When writing, reviewing, or refactoring code, state assumptions when needed, prefer the simplest working change, keep edits surgical, and verify with clear success criteria.
